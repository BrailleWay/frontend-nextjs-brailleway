...
export default function Section7(){
    ...
    return(
        <div className='bg-[linear-gradient(to_right,_#4BA8FF_0%,_#1C71E4_47%,_#44D7D1_100%)]'>
            <div className='text-white lg:max-w-8xl mx-auto flex flex-col'>
                ...
                <div id="planos" className='lg:justify-center sm:justify-center sm:mx-auto mt-4 gap-20 p-10 mb-10 md:mx-auto w-fit bg-white mx-2.5 lg:mx-auto rounded-4xl  font-["Poppins-medium"]'>
                    <div className=' '>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            <div id="plano1" className=' space-y-3  p-10  flex flex-col hover:shadow-3xl hover:-translate-y-10 ease-in-out transition hover:scale-105 duration-300 group hover:bg-gradient-to-r hover:from-[#6941EB] hover:via-[#6941EB] hover:to-[#4BA8FF] rounded-4xl bg-white'>
                                <div className=' text-[#1C71E4] flex max-w-xs w-screen justify-end'><p className='bg-white rounded-4xl px-6 py-1 outline outline-[#6941EB] group-hover:outline-none transition duration-300 ease-in-out '>Mais Popular</p></div>
